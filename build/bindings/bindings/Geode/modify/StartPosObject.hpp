...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, StartPosObject> : ModifyBase<ModifyDerive<Der, StartPosObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a59d0, Default, StartPosObject, customObjectSetup, gd::vector<gd::string>&, gd::vector<void*>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a5880, Default, StartPosObject, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a59e0, Default, StartPosObject, getSaveString, GJBaseGameLayer*)
		}
	};
}
