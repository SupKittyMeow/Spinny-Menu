...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MoreVideoOptionsLayer> : ModifyBase<ModifyDerive<Der, MoreVideoOptionsLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x762a30, Default, MoreVideoOptionsLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x764ae0, Default, MoreVideoOptionsLayer, keyBackClicked, )
		}
	};
}
